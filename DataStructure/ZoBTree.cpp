...
void ZoBTree::BTree_insert(BTree* tree, KeyType key)
{
	BTNode* node;
	BTNode* root = *tree;
...
void ZoBTree::BTree_remove(BTree* tree, KeyType key)
{
#ifdef DEBUG_BTREE  
	printf("BTree_remove:\n");
#endif  
...
BTNode* ZoBTree::BTree_search(const BTree tree, KeyType key, int* pos)
{
#ifdef DEBUG_BTREE  
	printf("BTree_search:\n");
#endif  
...
//===============================create===============================  
void ZoBTree::BTree_create(BTree* tree, const KeyType* data, int length)
{
	assert(tree);
...
//===============================destroy===============================  
void ZoBTree::BTree_destroy(BTree* tree)
{
	int i;
	BTNode* node = *tree;
